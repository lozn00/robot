...
public class FloatWinfowServices extends Service {
    ...
    private void initFloating() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ProxySendAlertUtil.isAlerting()){
                    ProxySendAlertUtil.cancel();
                    return;
                }
                Intent intent = new Intent(FloatWinfowServices.this, MainActivity.class);
    ...
    private void initWindow() {
        ...
        // 获取浮动窗口视图所在布局
        mFloatingLayout = inflater.inflate(R.layout.floating_remoteview, null);
        // 添加悬浮窗的视图
        winManager.addView(mFloatingLayout, wmParams);
    }

    public WindowManager.LayoutParams getMyParam() {
