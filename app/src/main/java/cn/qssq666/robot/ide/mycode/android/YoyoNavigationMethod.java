...
public class YoyoNavigationMethod extends TouchNavigationMethod {
    ...
    private void moveHandle(Yoyo _yoyo, MotionEvent e) {
        ...
        MyPair foundIndex = _yoyo.findNearestChar((int) e.getX(), (int) e.getY());
    ...
    private class Yoyo {
         ...
         *
         * @return MyPair.first contains the nearest character while MyPair.second
         * is the exact character found by a strict search
         */
        public MyPair findNearestChar(int handleX, int handleY) {
            ...
            return new MyPair(_textField.coordToCharIndex(attachedLeft, attachedBottom),
