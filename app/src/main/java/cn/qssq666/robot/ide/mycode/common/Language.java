...
public abstract class Language {
    ...
    private final static String[] BASIC_C_OPERATORS_CHAR = {};
    ...
    protected HashMap<String, Integer> _operators_str = generateOperatorsStr(BASIC_C_OPERATORS_CHAR);
    ...
    protected void setOperators(String[] operators) {
        _operators_str = generateOperatorsStr(operators);
    }
    ...
    private HashMap<String, Integer> generateOperatorsStr(String[] operators) {
        HashMap<String, Integer> operatorsMap = new HashMap<String, Integer>(operators.length);
        for (int i = 0; i < operators.length; ++i) {
            operatorsMap.put(operators[i], Lexer.OPERATOR);
        }
        return operatorsMap;
    ...
    public final boolean isOperator(String str) {
        return false;
//        return _operators_str.containsKey(str);
    }
    ...
    public boolean isMethodAppendToken(LuaTokenTypes lastType) {
//        String name = lastType.name();
