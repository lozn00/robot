...
public class LanguageLua extends Language {
    ...
    /*
        ...
        env.set("warn", new errorFunction());
        env.set("info", new errorFunction());
        ...
        return utilLibrary;
     */
    private final static String keywordTarget = "and|break|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|then|true|until|while|cn.qssq666.robot.sdk";
    private final static String globalTarget = "__add|__band|__bnot|__bor|__bxor|__call|__concat|__div|" +
            "__eq|__idiv|__index|__le|__len|__lt|__mod|__mul|__newindex|__pow|__shl|__shr|__sub|__unm|_ENV|_G|assert|collectgarbage|dofile|error|findtable|getmetatable|ipairs|load|" +
            "loadfile|loadstring|module|next|pairs|pcall|print|rawequal|rawget|rawlen|rawset|require|select|self|setmetatable|tointeger|tonumber|tostring|" +
            "type|unpack|xpcall|log|debug|warn|logw|toast|onReceiveMsgIsNeedIntercept|onReceiveOtherIntercept|onReceiveRobotFinalCallMsgIsNeedIntercept" +
    ...
    private final static String packageName = "coroutine|debug|io|luajava|math|os|package|string|table|utf8|api|config|robot";
    ...
    private final static String package_robot_versioninfo = "name|code|build|package";
    ...
    private final static String[] LUA_OPERATORS_1 = {".."};
...
//        super.setOperators(LUA_OPERATORS_1);
...
//        super.set
        ...
        super.addBasePackage("robot", package_robot_versioninfo.split("\\|"));
