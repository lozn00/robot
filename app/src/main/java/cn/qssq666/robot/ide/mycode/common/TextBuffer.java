...
import cn.qssq666.CoreLibrary0;import java.util.List;
...
public class TextBuffer implements java.lang.CharSequence
{
	...
	synchronized public int getLineOffset(int lineNumber){
		...
		MyPair cachedEntry = _cache.getNearestLine(lineNumber);
	...
	synchronized public int findLineNumber(int charOffset){
		...
		MyPair cachedEntry = _cache.getNearestCharOffset(charOffset);
	...
	public void clearSpans(){
		_spans = new Vector<MyPair>();
	    _spans.add(new MyPair(0, Lexer.NORMAL));
	}
	
	public List<MyPair> getSpans(){
		return _spans;
	}
	 ...
	 */
	public void setSpans(List<MyPair> spans){
		_spans = spans;
	}
